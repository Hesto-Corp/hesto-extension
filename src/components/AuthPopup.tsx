      ...
      <CardContent className="flex-grow p-4 flex flex-col justify-center">
        ...
        <div className="mt-3 flex justify-center space-x-2">
          <Button
            ...
            variant="outline"
            className="flex-1 flex items-center justify-center border-gray-300 hover:bg-gray-50"
          >
        ...
        <p className="text-center text-sm text-gray-600 mt-3">
          ...
          <a href="https://hesto.org/signup" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700 font-medium">
            Sign up
          </a>
        </p>
      </CardContent>
